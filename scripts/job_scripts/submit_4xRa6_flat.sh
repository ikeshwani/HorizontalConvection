...
#SBATCH --job-name="GRC-4xRa6-flat"             ## Name of the job.
#SBATCH --output="/work/hdd/bfxn/ikeshwani/HorizontalConvection/output/GPU/GRC/ra1e6_4xstretch_flat_baseforcing_zerostart/logs/output_message.%j.out"             ##output file
...
julia --project=../ job_scripts/run_4xRa6_flat.jl