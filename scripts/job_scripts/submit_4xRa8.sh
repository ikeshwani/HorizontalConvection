...
#SBATCH --output="/work/hdd/bfxn/ikeshwani/HorizontalConvection/output/GPU/GRC/ra1e8_4xstretch_threehill_baseforcing_zerostart/logs/output_message.%j.out"             ##output file
...
julia --project=../ job_scripts/run_3hill_4xRa8.jl