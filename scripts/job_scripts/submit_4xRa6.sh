...
#SBATCH --job-name="GRC-4xRa6"             ## Name of the job.
#SBATCH --output="/work/hdd/bfxn/ikeshwani/HorizontalConvection/output/GPU/GRC/ra1e6_4xstretch_threehill_baseforcing_zerostart/logs/output_message.%j.out"             ##output file
...
julia --project=../ job_scripts/run_3hill_4xRa6.jl